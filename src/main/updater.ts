 ...
 * выходе из приложения. Подпись инсталлятора проверяется electron-updater'ом
 * (build.win.verifyUpdateCodeSignature + build.win.publisherName) — неподписанное
 * или подписанное другим издателем обновление будет отклонено.
 */
